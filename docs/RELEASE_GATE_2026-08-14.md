...
| Exact-live parity and Core Web Vitals | **BLOCK**                      | Exact-candidate parity capture produced no report and was terminated after exceeding its expected bound. Prior-revision numbers are not reused.                                                             |
...
3. Complete one genuine live $5 supporter payment and admit its signed webhook
   receipt.
4. Re-run the exact-live three-theme parity/Core Web Vitals capture.
