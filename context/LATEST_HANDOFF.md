...
- Verification: exact revision `67f4811a893f6fc9f4f34ea3fea9dc04c25ffa74` passed CI `31216814158`, E2E `31216814121`, Release `31216814112`, brief-format, Dependabot, all 232 files / 1,221 tests, production audit, build, lint, format, bundle, and exact release evidence. DOMPurify is pinned to the trust-approved, PGP-signed 3.4.13 security release.
